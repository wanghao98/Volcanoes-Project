...
```{r, echo=FALSE, fig.height=5, fig.width=5, fig.cap="Obs 10 Type: 1 Radius: 22.02 Number Volcanoes: 1", fig.align='center'}
par(mfrow = c(2, 2))
volplot(train_data, 10)
```

```{r, echo=FALSE, fig.height=5, fig.width=5, fig.cap="Obs 39 Type: 2 Radius: 19.31 Number Volcanoes: 1", fig.align='center'}
par(mfrow = c(2, 2))
volplot(train_data, 39)
```


```{r, echo=FALSE, fig.height=5, fig.width=5, fig.cap="Obs 1 Type: 3 Radius: 17.46 Number of Volcanoes: 1", fig.align='center'}
par(mfrow = c(2, 2))
volplot(train_data, 1)
```

```{r, echo=FALSE, fig.height=5, fig.width=5, fig.cap="Obs 30 Type: 4 Radius: 6.40 Number Volcanoes: 1", fig.align='center'}
par(mfrow = c(2, 2))
# train_y[which(train_y$Number.Volcanoes == 2),]
volplot(train_data, 30)
```

```{r, echo=FALSE, fig.height=5, fig.width=5, fig.cap="Obs 289 Type: 1 Radius: 11.05 Number Volcanoes: 2", fig.align='center'}
par(mfrow = c(2, 2))
# train_y[289,]
volplot(train_data, 289)
```

```{r, echo=FALSE, fig.height=5, fig.width=5, fig.cap="Obs 2 No Volcano", fig.align='center'}
# train_y[2,]
par(mfrow = c(2, 2))
...
Variable selection methods we used:
...
By applying those two different selection methods, we found the accuracy of Lasso selection is higher. Therefore, we may conclude that lasso' more spread pixels made more sense because Marginal Screening's centered selection might ignore some important pixels at the egdes. 
