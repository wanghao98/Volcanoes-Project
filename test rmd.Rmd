...
# levels(train_y$Type) <- c("definitely a volcano", "probably", "possibly", "only a pit is visible", "no volcano")
ggplot(train_y[(train_y$Number.Volcanoes != "NaN"),], aes(x = Number.Volcanoes, fill = Number.Volcanoes)) +
  geom_bar(stat='count') +
...
![The Marginal Screening index for classification](./M_C.png)

![The Lasso index for classification](./Lasso_C.png)

![The Marginal Screening index for Poisson prediction](./M_p.png)

![The Lasso index for Poisson prediction](./lasso_P.png)
