...
This dataset is originally from NASA's Magellan spacecraft database. For this project, we aim in constructing mainly classification model to predict the valcanoes on Venus using the images dataset. If the classification model works well, we will continue to construct regression model to predict the number of volcanoes in the images.  
